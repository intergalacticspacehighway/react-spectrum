...
import { TabList, TabPanels } from '../src';
      ...
      <Item title="Tab 1" key="val1">
          <Content margin="size-160">
            ...
            <Text>
              ...
              Consequat adipisicing irure Lorem commodo officia fsint id. Velit sit magna aliquip eiusmod non id deserunt. Magna veniam ad consequat dolor cupidatat esse enim Lorem ullamco. Anim excepteur consectetur id in. Mollit laboris duis labore enim duis esse reprehenderit.
            </Text>
          </Content>
        </Item>
        <Item title="Tab 2" key="val2">
...
let OrientationFlip = (props = {}) => {
  ...
  return (
    <div style={{width: '80%'}}>
      <Tabs {...props} aria-label="Tab example" onSelectionChange={action('onSelectionChange')} orientation={flipOrientation ? 'horizontal' : 'vertical'}>
        <TabList items={items}>
          {item => (
            <Item
              key={item.name}
